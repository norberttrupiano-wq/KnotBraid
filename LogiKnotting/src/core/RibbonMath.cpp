...
// File        : src/core/RibbonMath.cpp
// Created     : 2026-03-06
// Updated     : 2026-03-07
// Description :
// ============================================================
#include "RibbonMath.h"
#include <cmath>

namespace Core::RibbonMath
{
double wrap(double x, double length)
{
    ...
    double r = std::fmod(x, length);
    if (r < 0.0)
        r += length;
    return r;
}

double applyOffset(double x, double offset, double length)
{
    return wrap(x + offset, length);
}

double removeOffset(double x, double offset, double length)
{
    return wrap(x - offset, length);
}
}
