...
// File        : src/core/CylinderTopology.h
// Created     : 2026-03-06
// Updated     : 2026-03-07
// Description :
// ============================================================
...
{
public:
    static std::int32_t wrapMod(std::int64_t xAbs, std::int32_t length);
    static std::int64_t unwrapNearest(std::int32_t xMod, std::int64_t anchorXAbs, std::int32_t length);
    static std::int32_t shortestDeltaMod(std::int32_t fromMod, std::int32_t toMod, std::int32_t length);
    static std::int32_t turnOf(std::int64_t xAbs, std::int32_t length);
};
}
